...
requires_pptx = pytest.mark.skipif(not HAS_PPTX, reason="python-pptx not installed")
requires_ebooklib = pytest.mark.skipif(not HAS_EBOOKLIB, reason="ebooklib not installed")
